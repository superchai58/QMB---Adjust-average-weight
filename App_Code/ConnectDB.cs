...
public class ConnectDB
{
    ...
    //private string connStr = "Data Source=10.97.2.31;Initial Catalog=SMT; Persist Security Info=True; User ID=sa;Password=pqmb#7sa;";
    private string connStr = "Data Source=10.94.1.11;Initial Catalog=SMT; Persist Security Info=True; User ID=sa;Password=pqmb#7sa;";
